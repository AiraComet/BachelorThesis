...
\maketitle
\begin{abstract}
\noindent While there are many math information systems in existence that either have a formal or informal approach to representing mathematical knowledge there is also a need for a system for flexiformal documents that contain both, formal and informal, components.
...
They both have their own elements and and several layers of children, resulting in this tree structure.
\newline \newline
...
Opaque elements are just text that help the user to understand the content of the document.
