...
As it can be seen in figure \ref{fig:architecture} the React frontend is in constant communication with the MMT MathHub plugin of an MMT server that provides the user with the actual content as well as several semantic services.
