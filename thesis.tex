...
\newline \newline
MMT builds on the \textbf{OMDoc} representation, which is a philosophy about the design of an uniform language for knowledge.
...
The representation of this data, knowledge and structure with varying degrees of formality is called \textbf{flexiformal}.\ednote{ref herer}
